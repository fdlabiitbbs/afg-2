export const ResearchFacility = [
    {
        ...
        content:"A state-of-the-art wind tunnel facility is available with a test section size of 1 m × 1m and 4 m in length with a turbulence level of less than 0.5%. The wind tunnel is equipped with a gust generator and a passive grid. An active free-stream turbulence generator facility is also available. The wind tunnel can cater up to a free stream velocity of 50 m/s. The wind tunnel is equipped with various instruments to measure unsteady forces and moments."
    },
    {
        id: 2,
        title: "Time-Resolved Particle Image Velocimetry (TR-PIV)",
        content: "Time-Resolved Particle Image Velocimetry (TR-PIV) is an advanced experimental technique used in fluid dynamics research to measure fluid flow velocity over time. It involves the use of high-speed cameras to capture a sequence of images of tracer particles seeded in the fluid. The images are then analyzed to determine the particle displacement and velocity at various time intervals, providing a detailed insight into the fluid flow dynamics."
    },
    {
        id: 3,
        title: "Hotwire Anemometry",
        content: "Hotwire anemometer is a sophisticated instrument used for measuring turbulence in fluid flows with exceptional temporal resolution. We have a dedicated four-channel fully automated Hotwire anemometer system with 3D traverse and various probes (Single wire, X wire, and Boundary layer)"
    },
    {
        id: 4,
        title: "Pressure Measurement System",
        content: "Our laboratory is equipped with various steady and unsteady pressure measurement systems to cater to various ranges of pressure measurement for subsonic and supersonic flows."
    },
    {
        id: 5,
        title: "Infrared Camera",
        content: "A high-resolution Infrared camera is available to acquire two-dimensional temperature field measurements."
    },
    {
        id: 6,
...
export const TechnologiesDeveloped = [
    ...
    },
    {
        ...
        novelty: "A novel contraction cone design is proposed and implemented, which makes the flowmeter insensitive to any upstream disturbances and hence doesn’t require any straight piping upstream and downstream of the flowmeter."
    },
    {
        id: 3,
        title: "A System And A Method To Create And Modulate Coaxial Synthetic Jets",
        ...
        novelty: "We proposed and demonstrated a Coaxial Synthetic Jet (CSJ) system for flow control application. By employing two piezo-electric diaphragms arranged coaxially with a 0° orientation angle, the system generates and controls flow jets to achieve the desired effect. These diaphragms can be independently operated at different amplitudes and frequencies without affecting the flow in either cavity. Moreover, the CSJ allows for adjusting phase differences between the diaphragms, ranging from 0° to 180°, providing versatile modulation capabilities. The compact design of the CSJ enables easy integration into electronic components, aerodynamics flow control, mixing, and combustion applications. With its ability to achieve different mass flux ratios, the CSJ represents a significant advancement in flow control technology."
    },
    {
        id: 4,
        ...
        background: "Many engineering applications like, aerodynamics, electronics cooling, and process industries and combustion requires effective utilization of fluids. Such applications demand an active flow control technique to manipulate the flow field to achieve the desired effects like turbulence enhancement and vortices. Existing flow control devices have limited scope due to their ineffectiveness in manipulating the flow field to achieve these desired effects.",
        novelty: "The present invention introduces an innovative focusing technique to enhance the strength of synthetic jets (SJs) in the far-field. SJs often suffer from reduced vortex coherence, limiting their wide applicability. This issue also affects synthetic jet arrays (SJ arrays) composed of multiple adjacent actuators, where destructive interactions between opposite rotating vortices decrease coherence in the far field. The inventors propose focusing as a method to mitigate these destructive interactions in the near field, allowing vortices to evolve effectively, which results in achieving 50% enhancement in jet strength in the far field. Subsequently, constructive merging between vortices amplifies the jet strength in the far field. This novel focusing of SJs holds tremendous potential for enhancing electronic cooling, aerodynamics, and other applications."
    },
    {
        id: 5,
