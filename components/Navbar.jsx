...
import googleScholar from "@/assets/googleScholar.jpg"
              ...
              <ul className="h-screen lg:h-auto items-center justify-center lg:flex ">
                ...
                <li className="mb-4 lg:block hidden">
                  <div className="group relative cursor-pointer">
                    <div>
                      <a className="cursor-pointer text-xl menu-hover text-white py-2 px-6 text-center lg:hover:bg-slate-600 rounded-md">
                        Research
                      </a>
                    </div>
                ...
                <li className="mb-4">
                  <Link
                    className="py-2 px-6 cursor-pointer text-xl text-white lg:hover:bg-slate-600 rounded-md flex items-center"
                  ...
                  >
                    ...
                    <Image src={googleScholar} className="h-full w-24" />
                  </Link>
                </li>
